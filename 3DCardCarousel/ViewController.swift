...
//  3DCardCarousel
//
//  Created by Sezgin Çiftci on 29.12.2021.
//

import UIKit

func degreeToRadiant(deg: CGFloat) -> CGFloat {
...
class ViewController: UIViewController {
    ...
    func turnCarousel(){
        ...
        var angleOffset = currentOffset
        
        for layer in transformSubLayers {
            var transform = CATransform3DIdentity
            transform.m34 = -1/500
            
            transform = CATransform3DRotate(transform, degreeToRadiant(deg: angleOffset), 0, 1, 0)
